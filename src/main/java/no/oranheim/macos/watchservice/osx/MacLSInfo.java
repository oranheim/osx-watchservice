...
public class MacLSInfo {
    ...
    @SuppressWarnings("unused")
    private void setAppDefault(String app) {
        this.defApp = app;
    }
    ...
    @SuppressWarnings("unused")
    private void setApplications(Object[] apps) {
        this.apps = apps;
    }
    ...
    public boolean isPlainFile() {
        return (flags & kLSItemInfoIsPlainFile) != 0;
    }
    ...
    public boolean isApplication() {
        return (flags & kLSItemInfoIsApplication) != 0;
    }

    public boolean isContainer() {
        return (flags & kLSItemInfoIsContainer) != 0;
    }

    public boolean isAliasFile() {
        return (flags & kLSItemInfoIsAliasFile) != 0;
    }

    public boolean isSymlink() {
        return (flags & kLSItemInfoIsSymlink) != 0;
    }
    ...
    public boolean isVolume() {
        return (flags & kLSItemInfoIsVolume) != 0;
    }
